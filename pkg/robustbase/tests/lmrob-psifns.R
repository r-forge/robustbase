...
## Demonstrate lmrob.tau.fast.coefs() computations:
...
lmrob.tauFC <- list(optimal = list(c = 1.060158, tfc = c(tfact = 0.94735878, tcorr = -0.09444537)),
                    ...
                    hampel  = list(c = c(1.35241275, 3.15562975, 7.212868),
                                   tfc = c(tfact = 0.94739770, tcorr = -0.04103958)))
